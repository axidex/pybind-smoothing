...
void Smoothing::set_sigmaColor(int sigmaColor) { this->sigmaColor = sigmaColor; }
void Smoothing::set_sigmaSpace(int sigmaSpace) { this->sigmaSpace = sigmaSpace; }
...
void Smoothing::detectAndDraw()
{
    ...
    for (std::vector<cv::Rect>::const_iterator r = faces.begin(); r != faces.end(); r++, i++)
    {
        ...
        int value1 = sigmaColor, value2 = sigmaSpace;
